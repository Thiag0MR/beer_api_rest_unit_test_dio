...
import com.digitalinnovation.beerapi.builder.BeerDTOBuilder;
...
public class BeerServiceTest {
	...
	void whenBeerInformedThenItShouldBeCreated() throws BeerAlreadyRegisteredException {
        ...
        Beer expectedSavedBeer = beerMapper.beerDtoToBeer(expectedBeerDTO);
    ...
    void whenAlreadyRegisteredBeerInformedThenAnExceptionShouldBeThrown() {
        // given
        BeerDTO expectedBeerDTO = BeerDTOBuilder.builder().build().toBeerDTO();
        Beer duplicatedBeer = beerMapper.beerDtoToBeer(expectedBeerDTO);
    ...
    void whenValidBeerNameIsGivenThenReturnABeer() throws BeerNotFoundException {
        ...
        // then
        BeerDTO foundBeerDTO = beerService.findBeerByName(expectedFoundBeerDTO.getName());
    ...
    void whenNotRegisteredBeerNameIsGivenThenThrowAnException() {
        ...
        // then
        assertThrows(BeerNotFoundException.class, () -> beerService.findBeerByName(expectedFoundBeerDTO.getName()));
    }
    ...
    void whenListBeerIsCalledThenReturnAListOfBeers() {
        ...
        //then
        List<BeerDTO> foundListBeersDTO = beerService.listBeers();
    ...
    void whenExclusionIsCalledWithValidIdThenABeerShouldBeDeleted() throws BeerNotFoundException{
        ...
        Beer expectedDeletedBeer = beerMapper.beerDtoToBeer(expectedDeletedBeerDTO);
