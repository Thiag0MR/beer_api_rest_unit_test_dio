...
import static com.digitalinnovation.beerapi.utils.JsonConvertionUtils.asJsonString;
...
public class BeerControllerTest {
    ...
    void whenGETIsCalledWithValidNameThenOkStatusIsReturned() throws Exception {
        ...
        //when
        when(beerService.findBeerByName(beerDTO.getName())).thenReturn(beerDTO);
    ...
    void whenGETIsCalledWithoutRegisteredNameThenNotFoundStatusIsReturned() throws Exception {
        ...
        //when
        when(beerService.findBeerByName(beerDTO.getName())).thenThrow(BeerNotFoundException.class);
    ...
    void whenGETListWithBeersIsCalledThenOkStatusIsReturned() throws Exception {
        ...
        //when
        when(beerService.listBeers()).thenReturn(Collections.singletonList(beerDTO));
