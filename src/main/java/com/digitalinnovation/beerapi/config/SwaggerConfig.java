package com.digitalinnovation.beerapi.config;
...
public class SwaggerConfig {
    ...
    private static final String CONTACT_NAME = "Thiago Mendes";
    private static final String CONTACT_GITHUB = "https://github.com/Thiag0MR";
